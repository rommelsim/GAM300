...
namespace AeonScripts
{
    ...
    public class PauseMenuLevel2 : AeonBehaviour
    {
        public PauseLevel2Option currPoption { get; set; }
        ...
        public static string selectLeftYes2 = "select_Left_Yes_2";
        public static string selectRightNo2 = "select_Right_No_2";
        ...
        public override void OnCreate()
        {
            ...
            bgm = Entity.FindEntityByName("GameBGM");
            ...
            Input.RegisterMapping(selectLeftYes2, Input.KBMInputType.Keyboard, Keys.KEY_J, Input.JoystickInput.Button_Dpad_Left);
            Input.RegisterMapping(selectRightNo2, Input.KBMInputType.Keyboard, Keys.KEY_K, Input.JoystickInput.Button_Dpad_Right);
            ...
            currPoption = PauseLevel2Option.Resume;
        ...
        public override void Update()
        {
            ...
            if (GameState.IsPaused && ((DateTime.Now - lastInputTime).TotalSeconds >= inputCooldown))
            {
                RunPause(gamepad);
            }                
        }
        ...
        public void RunPause(int gamepad)
        {
            if (!isOverlay)
            {
                ...
                {
                    if (currPoption == PauseLevel2Option.Quit)
                    {
                        currPoption = PauseLevel2Option.Settings;
                    ...
                    else if (currPoption == PauseLevel2Option.Settings)
                    {
                        currPoption = PauseLevel2Option.Restart;
                    ...
                    else if (currPoption == PauseLevel2Option.Restart)
                    {
                        currPoption = PauseLevel2Option.Resume;
                ...
                {
                    if (currPoption == PauseLevel2Option.Resume)
                    {
                        currPoption = PauseLevel2Option.Restart;
                    ...
                    {
                        currPoption = PauseLevel2Option.Quit;
                ...
                if (Input.GetMappingGamePadButtonPressed(confirm_option, gamepad) || Input.GetMappingKeyPressed(confirm_option))
                {
                    ...
                    if (currPoption == PauseLevel2Option.Settings)
                    {
                    ...
                    if (currPoption == PauseLevel2Option.Restart)
                    {
                        //GameData.isLevel2 = false;
                        //GameState.IsPaused = false;
                        GameState.SetEnginePauseState(false);
                        SceneManager.RemoveSceneFromCache(GameData.GameLvl2SceneFile);
            ...
            {
                if (Input.GetMappingKeyPressed(selectLeftYes2) || Input.GetMappingGamePadButtonPressed(selectLeftYes2, gamepad))
                {
                ...
                else if (Input.GetMappingKeyPressed(selectRightNo2) || Input.GetMappingGamePadButtonPressed(selectRightNo2, gamepad))
                {
